...
import { Card, Form, Input, Button, Divider, Switch, InputNumber, message, Row, Col, Tabs, Spin } from 'antd';
import { SaveOutlined, KeyOutlined, SettingOutlined } from '@ant-design/icons';
...
function SettingsPage() {
  ...
  return (
    <div>
      ...
      <Tabs items={tabItems} defaultActiveKey="general" size="large" />
    </div>
  );
}
